...
public class HashTable {
	...
	private GridNode [] table;			// Hash table - array of references to linked lists.
	...
	public void insert(int key) {
		int i = hash(key);
		table[i] = new GridNode(key, table[i]);
	}
	...
	public void print() {
		for (int i = 0; i < size; i++) {
			for (GridNode curr = table[i]; curr != null; curr = curr.next) 
